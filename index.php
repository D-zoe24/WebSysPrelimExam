...
<head>
    <title>Grade Calculator</title>
        ...
        <body>
            ...
            $final_grade = null;
            $letter = '';
            // Dito malalaman kung na submit na yung form
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                $quiz = $_POST['quiz'] ?? '';
                        ...
                        //dapat numeric yung input ng user
                        } elseif (
                        ...
                        // Formula para sa final grade and components na (Quiz:30%, Assignment:30%, Exam:40%)// 
                        } else {
                            $final_grade = ($quiz * 0.3) + ($assignment * 0.3) + ($exam * 0.4);

                            // Grading Remarks ng letter
                            if ($final_grade >= 90) {
                               $letter = 'A';
                   ...
                   // pag mali yung input na nilagay ng user
                   if ($error) {
                      echo "<div class='error' style='color:red;font-weight:bold;'>$error</div>";
                    // pag tama yung input na nilagay ng user
